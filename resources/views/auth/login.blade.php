	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="{{ route('login_validation') }}">
					<span class="login100-form-title">
						Sistem Pendukung Keputusan metode SAW
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Nama harus di isi">
						<input class="input100" type="text" name="username" placeholder="Nama User" {{request()->input('username')}}>
