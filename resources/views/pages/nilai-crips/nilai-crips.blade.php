...
@section('javascript')
    <script>
        ...
        function tambah() {
            window.location.href = "{!! route("getNilaiCrips") !!}?tambah=true"
        }
        ...
        $('.editData').on('click', function (e) {
            ...
            let newUrl = "{!! route("getNilaiCrips") !!}?kode=" + json.kode
            ...
            if (confirm('Yakin mau hapus?')) {
                $.ajax({
                    ...
                    success: function (respond) {
                        ...
                        if (respond == 'true') {
                            window.location.href = "{!! route("show_page", ["role" => $_SESSION['role'], "pages" => 'nilai-crips' ]) !!}"
                        }else{
