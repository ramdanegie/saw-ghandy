...
@section('javascript')
    <script>
        ...
        function tambah() {
            window.location.href = "{!! route("getNilaiAlternatif") !!}?tambah=true"
        }
        ...
        $('.editData').on('click', function (e) {
            ...
            let newUrl = "{!! route("getNilaiAlternatif") !!}?id=" + json.id
            ...
            if (confirm('Yakin mau hapus?')) {
                $.ajax({
                    ...
                    success: function (respond) {
                        ...
                        if (respond == 'true') {
                            window.location.href = "{!! route("show_page", ["role" => $_SESSION['role'], "pages" => 'nilai-alternatif' ]) !!}"
                        }else{
